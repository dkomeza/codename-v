...
import { History, Info, NotepadText, Settings } from "lucide-react";
  ...
  return (
    <div className="p-6 space-y-8">
      <div className="flex items-center rounded-full p-6 space-x-6 bg-red-400">
        <img src="pigeon.png" alt="Logo" className="w-16 h-16 object-cover" />
      ...
      <div className="flex flex-col items-center space-y-8">
        <Card className="w-auto max-w-xl flex flex-row items-center space-x-4 rounded-xl p-4">
          <Avatar>
